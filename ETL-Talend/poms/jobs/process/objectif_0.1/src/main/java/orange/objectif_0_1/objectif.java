 ...
 * @status
 */
public class objectif implements TalendJob {
	...
	private final String jobName = "objectif";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(objectif.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class tttStruct implements routines.system.IPersistableRow<tttStruct> {
		final static byte[] commonByteArrayLock_ORANGE_objectif = new byte[0];
		static byte[] commonByteArray_ORANGE_objectif = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final tttStruct other = (tttStruct) obj;
		...
		public void copyDataTo(tttStruct other) {
		...
		public void copyKeysDataTo(tttStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ORANGE_objectif.length) {
					if (length < 1024 && commonByteArray_ORANGE_objectif.length == 0) {
						commonByteArray_ORANGE_objectif = new byte[1024];
					} else {
						commonByteArray_ORANGE_objectif = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ORANGE_objectif, 0, length);
				strReturn = new String(commonByteArray_ORANGE_objectif, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ORANGE_objectif, 0, length);
				strReturn = new String(commonByteArray_ORANGE_objectif, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ORANGE_objectif) {
		 ...
		 * Compare keys
		 */
		public int compareTo(tttStruct other) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "ttt");
				}
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PlyjcBanaA1HrHloA36XC3xQ5cZmNFa2IBrAEkP3JD22Kp7inkM=");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "Time";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "Time";
				}
...
// # Outputs initialization
				tttStruct ttt_tmp = new tttStruct();
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:lSVCykfW/F8VavtVfT7ezSguQuAZ8obeukXmN6NY2zVyL9NmMYk=");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.Time_test.PK_Date,\n		dbo.Time_test.Date_Name,\n		dbo.Time_test.\"Year\",\n		dbo.Time_test.Year_Name,\n		dbo.Tim"
						+ "e_test.Half_Year,\n		dbo.Time_test.Half_Year_Name,\n		dbo.Time_test.Quarter,\n		dbo.Time_test.Quarter_Name,\n		dbo.Time_test"
						+ ".Trimester,\n		dbo.Time_test.Trimester_Name,\n		dbo.Time_test.\"Month\",\n		dbo.Time_test.Month_Name,\n		dbo.Time_test.Day_O"
						+ "f_Year,\n		dbo.Time_test.Day_Of_Year_Name,\n		dbo.Time_test.Day_Of_Half_Year,\n		dbo.Time_test.Day_Of_Half_Year_Name,\n		dbo"
						+ ".Time_test.Day_Of_Trimester,\n		dbo.Time_test.Day_Of_Trimester_Name,\n		dbo.Time_test.Day_Of_Quarter,\n		dbo.Time_test.Day_"
						+ "Of_Quarter_Name,\n		dbo.Time_test.Day_Of_Month,\n		dbo.Time_test.Day_Of_Month_Name,\n		dbo.Time_test.Month_Of_Year,\n		dbo.T"
						+ "ime_test.Month_Of_Year_Name,\n		dbo.Time_test.Month_Of_Half_Year,\n		dbo.Time_test.Month_Of_Half_Year_Name,\n		dbo.Time_tes"
						+ "t.Month_Of_Trimester,\n		dbo.Time_test.Month_Of_Trimester_Name,\n		dbo.Time_test.Month_Of_Quarter,\n		dbo.Time_test.Month_O"
						+ "f_Quarter_Name,\n		dbo.Time_test.Quarter_Of_Year,\n		dbo.Time_test.Quarter_Of_Year_Name,\n		dbo.Time_test.Quarter_Of_Half_Y"
						+ "ear,\n		dbo.Time_test.Quarter_Of_Half_Year_Name,\n		dbo.Time_test.Trimester_Of_Year,\n		dbo.Time_test.Trimester_Of_Year_Nam"
						+ "e,\n		dbo.Time_test.Half_Year_Of_Year,\n		dbo.Time_test.Half_Year_Of_Year_Name\nFROM	dbo.Time_test";
...
// # Output table : 'ttt'
							ttt_tmp.PK_Date = row1.PK_Date;
							ttt_tmp.Date_Name = row1.Date_Name;
							ttt_tmp.Year = row1.Year;
							ttt_tmp.Year_Name = row1.Year_Name;
							ttt_tmp.Half_Year = row1.Half_Year;
							ttt_tmp.Half_Year_Name = row1.Half_Year_Name;
							ttt_tmp.Quarter = row1.Quarter;
							ttt_tmp.Quarter_Name = row1.Quarter_Name;
							ttt_tmp.Trimester = row1.Trimester;
							ttt_tmp.Trimester_Name = row1.Trimester_Name;
							ttt_tmp.Month = row1.Month;
							ttt_tmp.Month_Name = row1.Month_Name;
							ttt_tmp.Day_Of_Year = row1.Day_Of_Year;
							ttt_tmp.Day_Of_Year_Name = row1.Day_Of_Year_Name;
							ttt_tmp.Day_Of_Half_Year = row1.Day_Of_Half_Year;
							ttt_tmp.Day_Of_Half_Year_Name = row1.Day_Of_Half_Year_Name;
							ttt_tmp.Day_Of_Trimester = row1.Day_Of_Trimester;
							ttt_tmp.Day_Of_Trimester_Name = row1.Day_Of_Trimester_Name;
							ttt_tmp.Day_Of_Quarter = row1.Day_Of_Quarter;
							ttt_tmp.Day_Of_Quarter_Name = row1.Day_Of_Quarter_Name;
							ttt_tmp.Day_Of_Month = row1.Day_Of_Month;
							ttt_tmp.Day_Of_Month_Name = row1.Day_Of_Month_Name;
							ttt_tmp.Month_Of_Year = row1.Month_Of_Year;
							ttt_tmp.Month_Of_Year_Name = row1.Month_Of_Year_Name;
							ttt_tmp.Month_Of_Half_Year = row1.Month_Of_Half_Year;
							ttt_tmp.Month_Of_Half_Year_Name = row1.Month_Of_Half_Year_Name;
							ttt_tmp.Month_Of_Trimester = row1.Month_Of_Trimester;
							ttt_tmp.Month_Of_Trimester_Name = row1.Month_Of_Trimester_Name;
							ttt_tmp.Month_Of_Quarter = row1.Month_Of_Quarter;
							ttt_tmp.Month_Of_Quarter_Name = row1.Month_Of_Quarter_Name;
							ttt_tmp.Quarter_Of_Year = row1.Quarter_Of_Year;
							ttt_tmp.Quarter_Of_Year_Name = row1.Quarter_Of_Year_Name;
							ttt_tmp.Quarter_Of_Half_Year = row1.Quarter_Of_Half_Year;
							ttt_tmp.Quarter_Of_Half_Year_Name = row1.Quarter_Of_Half_Year_Name;
							ttt_tmp.Trimester_Of_Year = row1.Trimester_Of_Year;
							ttt_tmp.Trimester_Of_Year_Name = row1.Trimester_Of_Year_Name;
							ttt_tmp.Half_Year_Of_Year = row1.Half_Year_Of_Year;
							ttt_tmp.Half_Year_Of_Year_Name = row1.Half_Year_Of_Year_Name;
							ttt = ttt_tmp;
// ###############################
...
// Start of branch "ttt"
						if (ttt != null) {
							...
							if (ttt.PK_Date != null) {
								pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(ttt.PK_Date.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Date_Name == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(2, ttt.Date_Name);
								} else {
									pstmt_tDBOutput_2.setString(2, ttt.Date_Name);
								}
							}

							if (ttt.Year != null) {
								pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(ttt.Year.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Year_Name == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(4, ttt.Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(4, ttt.Year_Name);
								}
							}

							if (ttt.Half_Year != null) {
								pstmt_tDBOutput_2.setTimestamp(5, new java.sql.Timestamp(ttt.Half_Year.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Half_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(6, ttt.Half_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(6, ttt.Half_Year_Name);
								}
							}

							if (ttt.Quarter != null) {
								pstmt_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(ttt.Quarter.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(7, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Quarter_Name == null) {
								pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(8, ttt.Quarter_Name);
								} else {
									pstmt_tDBOutput_2.setString(8, ttt.Quarter_Name);
								}
							}

							if (ttt.Trimester != null) {
								pstmt_tDBOutput_2.setTimestamp(9, new java.sql.Timestamp(ttt.Trimester.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(9, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Trimester_Name == null) {
								pstmt_tDBOutput_2.setNull(10, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(10, ttt.Trimester_Name);
								} else {
									pstmt_tDBOutput_2.setString(10, ttt.Trimester_Name);
								}
							}

							if (ttt.Month != null) {
								pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(ttt.Month.getTime()));
							} else {
								pstmt_tDBOutput_2.setNull(11, java.sql.Types.TIMESTAMP);
							}

							if (ttt.Month_Name == null) {
								pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(12, ttt.Month_Name);
								} else {
									pstmt_tDBOutput_2.setString(12, ttt.Month_Name);
								}
							}

							if (ttt.Day_Of_Year == null) {
								pstmt_tDBOutput_2.setNull(13, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(13, ttt.Day_Of_Year);
							}

							if (ttt.Day_Of_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(14, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(14, ttt.Day_Of_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(14, ttt.Day_Of_Year_Name);
								}
							}

							if (ttt.Day_Of_Half_Year == null) {
								pstmt_tDBOutput_2.setNull(15, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(15, ttt.Day_Of_Half_Year);
							}

							if (ttt.Day_Of_Half_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(16, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(16, ttt.Day_Of_Half_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(16, ttt.Day_Of_Half_Year_Name);
								}
							}

							if (ttt.Day_Of_Trimester == null) {
								pstmt_tDBOutput_2.setNull(17, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(17, ttt.Day_Of_Trimester);
							}

							if (ttt.Day_Of_Trimester_Name == null) {
								pstmt_tDBOutput_2.setNull(18, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(18, ttt.Day_Of_Trimester_Name);
								} else {
									pstmt_tDBOutput_2.setString(18, ttt.Day_Of_Trimester_Name);
								}
							}

							if (ttt.Day_Of_Quarter == null) {
								pstmt_tDBOutput_2.setNull(19, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(19, ttt.Day_Of_Quarter);
							}

							if (ttt.Day_Of_Quarter_Name == null) {
								pstmt_tDBOutput_2.setNull(20, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(20, ttt.Day_Of_Quarter_Name);
								} else {
									pstmt_tDBOutput_2.setString(20, ttt.Day_Of_Quarter_Name);
								}
							}

							if (ttt.Day_Of_Month == null) {
								pstmt_tDBOutput_2.setNull(21, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(21, ttt.Day_Of_Month);
							}

							if (ttt.Day_Of_Month_Name == null) {
								pstmt_tDBOutput_2.setNull(22, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(22, ttt.Day_Of_Month_Name);
								} else {
									pstmt_tDBOutput_2.setString(22, ttt.Day_Of_Month_Name);
								}
							}

							if (ttt.Month_Of_Year == null) {
								pstmt_tDBOutput_2.setNull(23, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(23, ttt.Month_Of_Year);
							}

							if (ttt.Month_Of_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(24, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(24, ttt.Month_Of_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(24, ttt.Month_Of_Year_Name);
								}
							}

							if (ttt.Month_Of_Half_Year == null) {
								pstmt_tDBOutput_2.setNull(25, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(25, ttt.Month_Of_Half_Year);
							}

							if (ttt.Month_Of_Half_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(26, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(26, ttt.Month_Of_Half_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(26, ttt.Month_Of_Half_Year_Name);
								}
							}

							if (ttt.Month_Of_Trimester == null) {
								pstmt_tDBOutput_2.setNull(27, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(27, ttt.Month_Of_Trimester);
							}

							if (ttt.Month_Of_Trimester_Name == null) {
								pstmt_tDBOutput_2.setNull(28, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(28, ttt.Month_Of_Trimester_Name);
								} else {
									pstmt_tDBOutput_2.setString(28, ttt.Month_Of_Trimester_Name);
								}
							}

							if (ttt.Month_Of_Quarter == null) {
								pstmt_tDBOutput_2.setNull(29, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(29, ttt.Month_Of_Quarter);
							}

							if (ttt.Month_Of_Quarter_Name == null) {
								pstmt_tDBOutput_2.setNull(30, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(30, ttt.Month_Of_Quarter_Name);
								} else {
									pstmt_tDBOutput_2.setString(30, ttt.Month_Of_Quarter_Name);
								}
							}

							if (ttt.Quarter_Of_Year == null) {
								pstmt_tDBOutput_2.setNull(31, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(31, ttt.Quarter_Of_Year);
							}

							if (ttt.Quarter_Of_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(32, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(32, ttt.Quarter_Of_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(32, ttt.Quarter_Of_Year_Name);
								}
							}

							if (ttt.Quarter_Of_Half_Year == null) {
								pstmt_tDBOutput_2.setNull(33, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(33, ttt.Quarter_Of_Half_Year);
							}

							if (ttt.Quarter_Of_Half_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(34, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(34, ttt.Quarter_Of_Half_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(34, ttt.Quarter_Of_Half_Year_Name);
								}
							}

							if (ttt.Trimester_Of_Year == null) {
								pstmt_tDBOutput_2.setNull(35, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(35, ttt.Trimester_Of_Year);
							}

							if (ttt.Trimester_Of_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(36, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(36, ttt.Trimester_Of_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(36, ttt.Trimester_Of_Year_Name);
								}
							}

							if (ttt.Half_Year_Of_Year == null) {
								pstmt_tDBOutput_2.setNull(37, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(37, ttt.Half_Year_Of_Year);
							}

							if (ttt.Half_Year_Of_Year_Name == null) {
								pstmt_tDBOutput_2.setNull(38, java.sql.Types.VARCHAR);
							} else {
								String driver = null;
								driver = "JTDS";
								if ("MSSQL_PROP".equals(driver)) {
									pstmt_tDBOutput_2.setNString(38, ttt.Half_Year_Of_Year_Name);
								} else {
									pstmt_tDBOutput_2.setString(38, ttt.Half_Year_Of_Year_Name);
								}
							}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "ttt");
				}
	...
	public static void main(String[] args) {
		final objectif objectifClass = new objectif();

		int exitCode = objectifClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = objectif.class.getClassLoader()
					.getResourceAsStream("orange/objectif_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = objectif.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : objectif");
		}
...
/************************************************************************************************
 * 128080 characters generated by Talend Open Studio for Data Integration on the
 * 7 mai 2022 à 13:02:00 CEST
 ************************************************************************************************/